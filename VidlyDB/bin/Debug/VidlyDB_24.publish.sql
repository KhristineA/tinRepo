...
GO
PRINT N'Creating Index [dbo].[RentHeaders].[IX_RentHeaders_Customer_Id]...';


GO
CREATE NONCLUSTERED INDEX [IX_RentHeaders_Customer_Id]
    ON [dbo].[RentHeaders]([Customer_Id] ASC);

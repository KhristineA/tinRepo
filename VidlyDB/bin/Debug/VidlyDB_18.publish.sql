...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_dbo.RentDetail_dbo.Movies_Movie_Id]...';


GO
ALTER TABLE [dbo].[RentDetails] DROP CONSTRAINT [FK_dbo.RentDetail_dbo.Movies_Movie_Id];
...
ALTER TABLE [dbo].[RentDetails] WITH NOCHECK
    ADD CONSTRAINT [FK_dbo.RentDetail_dbo.Movies_Movie_Id] FOREIGN KEY ([Movie_Id]) REFERENCES [dbo].[Movies] ([Id]) ON DELETE CASCADE ON UPDATE CASCADE;
...
GO
ALTER TABLE [dbo].[RentDetails] WITH NOCHECK
    ADD CONSTRAINT [FK_dbo.RentDetail_dbo.RentHeader_RentId] FOREIGN KEY ([RentId]) REFERENCES [dbo].[RentHeaders] ([RentId]) ON DELETE CASCADE ON UPDATE CASCADE;
